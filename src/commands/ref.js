...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('ref')
        .setDescription('Commandes utilisables uniquement par le·la référent·e.')
        ...
        .addSubcommand(subcommand => subcommand
            .setName('supprimer')
            .setDescription('⚠️ Supprimer les données et libérer l\'adresse mail associées à un compte Discord (irréversible).')
            .addUserOption(option => option
                .setName('compte')
                .setDescription('Le compte Discord à "supprimer" (s\'il n\'apparaît pas dans la liste, utilise son ID).')
                .setRequired(true)
            )
        ),
